...
const z = StyleSheet.create({
  ...
  chip: { paddingHorizontal: spacing.lg, paddingVertical: 7, borderRadius: radii.full, backgroundColor: colors.bg.tertiary, borderWidth: 1, borderColor: colors.border.default },
