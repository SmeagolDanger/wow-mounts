...
const z = StyleSheet.create({
  ...
  cb:{width:22,height:22,borderRadius:radii.full,borderWidth:2,borderColor:colors.border.subtle,alignItems:'center',justifyContent:'center'},
  ...
  badge:{flexDirection:'row',alignItems:'center',gap:2,backgroundColor:colors.bg.tertiary,paddingHorizontal:6,paddingVertical:2,borderRadius:radii.full},
